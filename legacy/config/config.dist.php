...
$conf['settings']['company.name'] = 'popcarte';                         // name of company, if applicable
$conf['settings']['company.url'] = 'http://localhost8080/Web';                          // URL of company, if applicable
...
$conf['settings']['script.url'] = 'http://localhost8080/Web';                           // public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = 'root';        // database user with permission to the librebooking database
$conf['settings']['database']['password'] = 'root';
$conf['settings']['database']['hostspec'] = 'db';        // ip, dns or named pipe
 ...
 */
$conf['settings']['install.password'] = 'popcarte';
/**
 * Pages
 */
